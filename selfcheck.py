...
print('№1 ' + str(fio == ['Лапицкая', 'Дарья', 'Дмитриевна']))
...
---------------начало блока редактирования----------------"""
surname_list = list('Лапицкая')

"""------------ конец блока редактирования----------------"""
print('№7 ' + str(surname_list == ['Л', 'а', 'п', 'и', 'ц', 'к', 'а', 'я']))

""" Задание №8
Получите в переменной 'surname_tuple' кортеж из букв вашей Фамилии по очереди
---------------начало блока редактирования----------------"""
surname_tuple = tuple('Лапицкая')

"""------------ конец блока редактирования----------------"""
print('№8 ' + str(surname_tuple == ('Л', 'а', 'п', 'и', 'ц', 'к', 'а', 'я')))

""" Задание №9
Получите в переменной 'res' список чётных чисел от 1 до длины вышей фамилии
---------------начало блока редактирования----------------"""
res = list(range(len('Лапицкая')))
res = res[2::2]
print(res)
...
---------------начало блока редактирования----------------"""
res = list()
for i in enumerate(list('Лапицкая')):
    res.append(tuple(i))
print(res)

"""------------ конец блока редактирования----------------"""
print('№10 ' + str(res == [(0, 'Л'), (1, 'а'), (2, 'п'), (3, 'и'), (4, 'ц'), (5, 'к'), (6, 'а'), (7, 'я')]))
...
"""------------ конец блока редактирования----------------"""
print('№11 ' + str(res == ['я', 'а', 'к', 'ц', 'и', 'п', 'а', 'Л']))
...
"""------------ конец блока редактирования----------------"""
print('№13 ' + str(res == ['Л', 'а', 'и', 'ц', 'к', 'а', 'я']))
